...
- When writing `지원동기`, make the motivation explicit: why this company, why this team, and why this role. Use the company service/business, team problem, and JD responsibilities to show what the candidate understands and what they can do after joining. Write it with real effort, but avoid unsupported affection, forced personal narrative, or vague desire; the reader should feel the candidate knows what work they would do and what help they can provide.
